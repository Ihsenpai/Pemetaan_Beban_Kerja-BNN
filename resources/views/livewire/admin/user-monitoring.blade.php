    ...
    <div class="bg-gradient-to-b from-blue-600 to-blue-800 py-8 shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-white">Monitoring Pengguna</h1>
                    <p class="text-blue-200 mt-2">Pantau semua pengguna sistem BNN Kabupaten Cilacap</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg border-l-4 border-green-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-600">Pegawai</h3>
                        <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Pegawai::count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg border-l-4 border-purple-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-600">Ketua Tim</h3>
                        <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Katim::count() }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-6 bg-white rounded-lg shadow-lg p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <!-- Role Filter -->
                <div class="md:w-48">
                    <select wire:model.live="selectedRole" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $roleColors = [
                                            ...
                                            'katim' => 'bg-green-100 text-green-800',
                                            'pimpinan' => 'bg-purple-100 text-purple-800',
                                        ];
                                    @endphp
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $roleColors[$user->role_class] ?? 'bg-gray-100 text-gray-800' }}">
                                        {{ $user->role }}
                                        @if(isset($user->katim_id))
                                            <br><span class="text-xs opacity-75">({{ $user->katim_id }})</span>
                                        @endif
                                    </span>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-6 py-12 text-center text-gray-500">
                                    ...
                                    <p class="text-sm">Tidak ada pengguna yang sesuai dengan kriteria pencarian</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
