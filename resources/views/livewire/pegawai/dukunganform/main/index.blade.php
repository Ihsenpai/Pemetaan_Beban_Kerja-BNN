    ...
    <div class="bg-gradient-to-b from-blue-600 to-blue-800 py-12 shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <h2 class="text-2xl font-bold text-white">Form Program Dukungan Manajemen</h2>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-2xl rounded-xl overflow-hidden transition-all duration-300 hover:shadow-blue-200/20">
            ...
            <div class="bg-gradient-to-r from-blue-700 to-blue-600 text-white p-8 text-center">
                ...
                <h3 class="text-lg mt-3 font-light">Program Dukungan Manajemen</h3>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-8 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-blue-100">
                    <button wire:click="toggleSection('bidang_tata_usaha')" class="w-full flex justify-between items-center bg-gradient-to-r from-blue-700 to-blue-600 text-white p-5 focus:outline-none group">
                        ...
                        <div class="w-6 h-6 flex items-center justify-center transform {{ $openSections['bidang_tata_usaha'] ? 'rotate-180' : '' }} transition-transform duration-500 ease-in-out group-hover:text-blue-200">
                            <span class="text-white text-lg">▼</span>
                        </div>
                    </button>
                    
                    @if($openSections['bidang_tata_usaha'])
                    <div class="p-8 bg-gradient-to-b from-blue-50 to-white transition-all duration-500 ease-in-out">
                        @include('livewire.pegawai.dukunganform.bidang-tata-usaha.soal')
                    </div>
                    @endif
                </div>
                ...
                <div class="mb-8 overflow-hidden shadow-md rounded-xl border border-blue-100">
                    <button wire:click="toggleSection('bidang_keuangan')" class="w-full flex justify-between items-center bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white p-5 focus:outline-none transition-all duration-300">
                        <span class="font-bold text-lg flex items-center">
                            <span class="bg-white text-blue-600 w-8 h-8 rounded-full flex items-center justify-center mr-3 shadow-sm">II</span>
                            BIDANG KEUANGAN DAN PERENCANAAN
                        </span>
                        <div class="w-6 h-6 flex items-center justify-center transform {{ $openSections['bidang_keuangan'] ? 'rotate-180' : '' }} transition-transform duration-300">
                            <span class="text-white text-lg">▼</span>
                        </div>
                    </button>
                    
                    @if($openSections['bidang_keuangan'])
                    <div class="p-6 bg-gradient-to-b from-blue-50 to-white">
                        @include('livewire.pegawai.dukunganform.bidang-keuangan.soal')
                    </div>
                    @endif
                </div>
                ...
                <!-- Bidang Kerjasama -->
                <div class="mb-8 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-blue-100">
                    <button wire:click="toggleSection('bidang_kerjasama')" class="w-full flex justify-between items-center bg-gradient-to-r from-blue-700 to-blue-600 text-white p-5 focus:outline-none group">
                        <span class="font-bold text-lg flex items-center">
                            <span class="bg-white text-blue-600 w-8 h-8 rounded-full flex items-center justify-center mr-3 shadow-sm">III</span>
                            BIDANG KERJASAMA
                        </span>
                        <div class="w-6 h-6 flex items-center justify-center transform {{ $openSections['bidang_kerjasama'] ? 'rotate-180' : '' }} transition-transform duration-500 ease-in-out group-hover:text-blue-200">
                            <span class="text-white text-lg">▼</span>
                        </div>
                    </button>
                    
                    @if($openSections['bidang_kerjasama'])
                    <div class="p-8 bg-gradient-to-b from-blue-50 to-white transition-all duration-500 ease-in-out">
                        @include('livewire.pegawai.dukunganform.bidang-kerjasama.soal')
                    </div>
                    @endif
                </div>
                ...
                <!-- Bidang Kehumasan -->
                <div class="mb-8 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-blue-100">
                    <button wire:click="toggleSection('bidang_kehumasan')" class="w-full flex justify-between items-center bg-gradient-to-r from-blue-700 to-blue-600 text-white p-5 focus:outline-none group">
                        <span class="font-bold text-lg flex items-center">
                        ...
                        <div class="w-6 h-6 flex items-center justify-center transform {{ $openSections['bidang_kehumasan'] ? 'rotate-180' : '' }} transition-transform duration-500 ease-in-out group-hover:text-blue-200">
                            <span class="text-white text-lg">▼</span>
                        </div>
                    </button>
                    
                    @if($openSections['bidang_kehumasan'])
                    <div class="p-8 bg-gradient-to-b from-blue-50 to-white transition-all duration-500 ease-in-out">
                        @include('livewire.pegawai.dukunganform.bidang-kehumasan.soal')
                    </div>
                    @endif
                </div>
                ...
                <div class="mb-8 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-blue-100">
                    <button wire:click="toggleSection('pembangunan_zi')" class="w-full flex justify-between items-center bg-gradient-to-r from-blue-700 to-blue-600 text-white p-5 focus:outline-none group">
                        <span class="font-bold text-lg flex items-center">
                            <div class="flex items-center justify-center w-8 h-8 rounded-full bg-white text-blue-600 mr-3">
                        ...
                        <div class="w-6 h-6 flex items-center justify-center transform {{ $openSections['pembangunan_zi'] ? 'rotate-180' : '' }} transition-transform duration-500 ease-in-out group-hover:text-blue-200">
                            <span class="text-white text-lg">▼</span>
                        </div>
                    </button>
                    
                    @if($openSections['pembangunan_zi'])
                    <div class="p-8 bg-gradient-to-b from-blue-50 to-white transition-all duration-500 ease-in-out">
                        @include('livewire.pegawai.dukunganform.pembangunan-zi.soal')
                    </div>
                    @endif
                </div>
                ...
                @include('components.kotak-saran', [
                    'formType' => 'dukungan',
                    'title' => 'Saran dan Masukan untuk Form Dukungan',
                    'placeholder' => 'Berikan saran atau masukan Anda untuk perbaikan form dukungan...'
                ])
                ...
                <div class="mb-10 bg-gradient-to-b from-blue-50 to-white p-8 rounded-xl shadow-lg border border-blue-200">
                    <h4 class="font-semibold text-blue-800 mb-6 text-xl text-center">
                        Ringkasan Penilaian Dukungan Manajemen
                    </h4>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @php
                            ...
                            if ($formStatus && isset($existingForm)) {
                                ...
                                $summary = [
                                    'total_tata_usaha' => $existingForm->total_tata_usaha ?? 0,
                                    'total_keuangan' => $existingForm->total_keuangan ?? 0,
                                    'total_kerjasama' => $existingForm->total_kerjasama ?? 0,
                                    'total_kehumasan' => $existingForm->total_kehumasan ?? 0,
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="text-blue-600 font-semibold mb-2">Bidang Tata Usaha</div>
                            <div class="text-2xl font-bold text-blue-800">{{ $summary['total_tata_usaha'] }}</div>
                        </div>
                        
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="text-blue-600 font-semibold mb-2">Bidang Keuangan dan Perencanaan</div>
                            <div class="text-2xl font-bold text-blue-800">{{ $summary['total_keuangan'] }}</div>
                        </div>
                        
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="text-blue-600 font-semibold mb-2">Bidang Kerjasama</div>
                            <div class="text-2xl font-bold text-blue-800">{{ $summary['total_kerjasama'] }}</div>
                        </div>
                        
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="text-blue-600 font-semibold mb-2">Bidang Kehumasan</div>
                            <div class="text-2xl font-bold text-blue-800">{{ $summary['total_kehumasan'] }}</div>
                        </div>
                        
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                            <div class="text-blue-600 font-semibold mb-2">Pembangunan Zona Integritas</div>
                            <div class="text-2xl font-bold text-blue-800">Data Text</div>
                            <div class="text-xs text-gray-600 mt-1">Tidak dihitung dalam total</div>
                        </div>
                    </div>
